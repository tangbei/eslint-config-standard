...
const baseStyleRules = require('@tangbei/eslint-config-standard-base/rules/style').rules;

const dangleRules = baseStyleRules['no-underscore-dangle'];

/**
 * eslint-plugin-react处理
 */
module.exports = {
  plugins: [
    'react',
  ...
  rules: {
    ...
    // 禁止某些propTypes (any, array, object)
